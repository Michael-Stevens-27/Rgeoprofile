...
download.file(url = "https://github.com/Michael-Stevens-27/Rgeoprofile/raw/workshop/docs/articles/images/Rstudio_welcome_numbered.png",
          destfile = "image1.png",
          mode = 'wb')
knitr::include_graphics(path = "image1.png")
``` -->

The interface should consist of four main panels: 
...
\  
<!-- ```{r, echo = F, out.width="400px"}
download.file(url = "https://github.com/Michael-Stevens-27/Rgeoprofile/raw/workshop/docs/articles/images/console.png",
          destfile = "image2.png",
          mode = 'wb')
...
\  
<!-- ```{r, echo = F, out.width="400px"}
download.file(url = "https://github.com/Michael-Stevens-27/Rgeoprofile/raw/workshop/docs/articles/images/control_enter.png",
          destfile = "image3.png",
          mode = 'wb')
...
\  
<!-- ```{r, echo = F, out.width="400px"}
download.file(url = "https://github.com/Michael-Stevens-27/Rgeoprofile/raw/workshop/docs/articles/images/copy.png",
          destfile = "image5.png",
          mode = 'wb')
...
\  
<!-- ```{r, echo = F, out.width="400px"}
download.file(url = "https://github.com/Michael-Stevens-27/Rgeoprofile/raw/workshop/docs/articles/images/save.png",
          destfile = "image6.png",
          mode = 'wb')
knitr::include_graphics(path = "image6.png")
``` -->

Notice the ".R" extension. This indicates that this file contains R code and as a consequence, Rstudio (or any other user interface for writing code) will colour the code syntax accordingly. For example, notice that comments are a different colour in our R script. Each coding language has its own extension, for example, if we were writing a piece of code using the python language our extension would be ".py".

## Assigning and naming objects 

The previous example of adding `1 + 2` gave us an immediate answer in the R console window, however, when writing R code, we may want to store a value so that we can use it later on in another piece of code. We can do this by **assigning** an object a specific value. Assigning objects can be done using the `<-` symbol. This symbol consists of the less than symbol `<` immediately followed by the minus symbol `-`. Let's see an example

\  
![](https://github.com/Michael-Stevens-27/Rgeoprofile/raw/workshop/docs/articles/images/assign.png)
\  
<!-- ```{r, echo = F, out.width="400px"}
download.file(url = "https://github.com/Michael-Stevens-27/Rgeoprofile/raw/workshop/docs/articles/images/assign.png",
          destfile = "image7.png",
          mode = 'wb')
...
\  
<!-- ```{r, echo = F, out.width="400px"}
download.file(url = "https://github.com/Michael-Stevens-27/Rgeoprofile/raw/workshop/docs/articles/images/assign_environment.png",
          destfile = "image8.png",
          mode = 'wb')
knitr::include_graphics(path = "image8.png")
``` -->

R has told us that there is an object named "x" with the value "5" assigned to it in the "global environment". This is essentially what is stored in R's memory. So when we assigned the value `5` to `x`, R placed `x` in its memory. To access `x`, we can run the following code.
