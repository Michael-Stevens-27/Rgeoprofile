...
* Now add an argument called “multiply” that will let the user choose a number to multiply the value by as well. Set the default value as 2 and test it on your random numbers again this time with the power set to 6 and the multiply set to 12 
