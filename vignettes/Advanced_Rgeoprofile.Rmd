...
We can see that the search priority has weakened inside Westminster and become tighter outside.  The `geoMask()` comes with many other operations too, see the function documentation for more options.
