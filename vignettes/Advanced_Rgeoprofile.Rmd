...
Once again, we shall load the packages we need for processing the output of the model.  
...
Clearly the DPM model is performing most efficiently, however the ring search gives us a better default search strategy than searching our area randomly. 
