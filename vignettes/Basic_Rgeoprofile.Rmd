...
This does not tell us too much. The `geoplotmap2()` function can be customised to display more information on the map. Let's add the sources and the crimes onto the map, as well as a legend that describes the colours we are seeing. 
